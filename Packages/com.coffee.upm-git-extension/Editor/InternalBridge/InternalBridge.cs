#if UNITY_2019_1_9 || UNITY_2019_1_10 || UNITY_2019_1_11 || UNITY_2019_1_12 || UNITY_2019_1_13 || UNITY_2019_1_14
        ...
        void UpdatePackageVersions(Package package, IEnumerable<string> versions)
        {
            ...
            var versionInfos = versions
                .Select(ver =>
                {
					...
					try
					{
						Expose.FromObject (package).Set ("IsInstalled", false);
					}
					catch(Exception e)
					{
						Expose.FromObject (package).Set ("IsCurrent", false);
					}
